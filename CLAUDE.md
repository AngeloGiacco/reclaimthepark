...
- **Measured area**: 4,384.52 sqm (0.44 hectares / 1.08 acres). Perimeter: 272.95m
...
2. **The concession details are unknown.** The expiry date, revenue terms, and break clauses of the Euro Car Parks agreement are the single most important unknowns. An FOI request has been submitted (see `/comms/foi/`). Until we have these, the campaign operates on estimates.
3. **This is Crown land inside a Grade I listed park.** Any proposal must respect heritage constraints. Historic England is a statutory consultee. This is why we don't prescribe a specific design — heritage sensitivity is a genuine constraint that requires expert input.
4. **We are not anti-car, anti-coach, or anti-tourism.** We simply argue that coach drop-off and accessible parking can be accommodated underground or relocated, and the surface of this land should serve the public better than tarmac.
5. **The Royal Parks are already moving in our direction.** They are currently consulting on permanently closing South Carriage Drive to weekday motor traffic. Our campaign aligns with their stated trajectory.
6. **Economic estimates are illustrative until confirmed by FOI.** Our economic analysis uses published data (GLA land values, King's Cross GVA reports, Serpentine visitor numbers) to model scenarios. Always caveat estimates and cite sources.
...
| Metric | Value | Source |
|--------|-------|--------|
| Site area | 4,384.52 sqm (0.44 ha / 1.08 acres) | Measured via satellite polygon tool |
| Site perimeter | 272.95m | Measured |
| Westminster residential land value | £93.3m per hectare | GLA Economics Evidence Base 2016 |
| Site opportunity cost (Westminster rate) | £40.9m | Derived: 0.44 ha × £93.3m/ha |
| Site opportunity cost (W2 4 median) | £64.0m | Derived: 4,385 sqm × £14,600/sqm |
...
| Estimated car park annual revenue | £0.5–1.0m | Illustrative, based on published tariffs |
| Implied return on land value | 1.2–2.4% | Derived: revenue / opportunity cost |
| King's Cross annual GVA | £1.42bn (67 acres / 27 ha) | King's Cross Group, 2021 |
| King's Cross GVA per hectare | ~£21m/ha/year | Derived from above |
| Potential annual GVA (conservative) | £8.8m | Derived: 0.44 ha × £20m/ha |
| Potential annual GVA (optimistic) | £17.5m | Derived: 0.44 ha × £40m/ha |
| 10-year opportunity cost | £78–165m | Derived: (potential GVA − car park revenue) × 10 |
...
- Third-party content (FOI responses, government data) retains its original licensing
